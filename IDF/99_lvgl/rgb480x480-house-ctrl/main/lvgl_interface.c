 ...
 * 字体转换网站: https://lvgl.io/tools/fontconverter
 ********************************************************************/
...
#include "device_st7701s.h"
#include "device_gt911.h"
...
void lvgl_disp_init(void)
{
    ...
    esp_lcd_rgb_panel_config_t panel_config = {
        ...
        .timings = {
            .pclk_hz = EXAMPLE_LCD_PIXEL_CLOCK_HZ, .h_res = EXAMPLE_LCD_H_RES, .v_res = EXAMPLE_LCD_V_RES, .hsync_back_porch = 50, .hsync_front_porch = 10, .hsync_pulse_width = 8, .vsync_back_porch = 20, .vsync_front_porch = 10, .vsync_pulse_width = 8,
            // .hsync_back_porch = 40,
