...
/*函数名称：timerAttachInterrupt()
  ...
  函数返回：无 */
  timerAttachInterrupt(timer, &TIM0_PeriodCallback, true);
...
void IRAM_ATTR TIM0_PeriodCallback()
{
  static uint16_t interruptCounter = 0;
    ...
    PWM_SetDuty(PWM_Channel_A, interruptCounter);
